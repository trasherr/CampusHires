...
export const ADMIN_ROUTES: RouteInfo[] = [
  {
    path: "/campusHiresDashboard/index",
    title: "Dashboard",
    icon: "icon-chart-pie-36",
    class: "",
    subMenu: []
  ...
  {
    path: "/campusHiresDashboard/calendar",
    title: "Calendar",
    icon: "icon-calendar-60",
    class: "" ,
    subMenu: []
  ...
  {
      path: "/campusHiresDashboard/candidate_list",
      title: "Candidate List",
      icon: "icon-bullet-list-67",
      class: "",
      subMenu:[]
  ...
  {
    path: "/campusHiresDashboard/notifications",
    title: "Notifications",
    icon: "icon-bell-55",
    class: "",
    subMenu: []
  ...
  {
    path: "/campusHiresDashboard/profile",
    title: "User Profile",
    icon: "icon-single-02",
    class: "",
    subMenu:[]
  ...
  {
    path: "/campusHiresDashboard/users",
    title: "Users",
    icon: "icon-single-02",
    class: "",
    subMenu: []
  ...
  {
    path: "/campusHiresDashboard/positions",
    title: "Positions",
    icon: "icon-tie-bow",
    class: "",
    subMenu: []
