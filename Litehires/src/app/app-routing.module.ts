...
import { LitehiresGuardGuard } from './guards/litehires-guard/litehires-guard.guard';
...
const routes: Routes = [
  {path: "",component:IndexComponent, title:"Litehires"},
  ...
  {path: "litehiresDashboard", component: LitehiresDashboardComponent,
    children : [
      // {path: "logout", component:LogoutComponent}
      {path:"",component:DashboardComponent, title:"Dashboard"},
      {path:"index",component:DashboardComponent, title:"Dashboard"},
   ...
   canActivate:[LitehiresGuardGuard]
  },
